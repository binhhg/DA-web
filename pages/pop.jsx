...
function Example() {
    ...
    function eventClassNames(eventInfo) {
        ...
        console.log(event.extendedProps.level)
        if (event.extendedProps.level === 1) return 'special-event'
    }
        ...
        <>
            <Button onClick={() => {
                ...
                a.addEvent({
                    id: 'aaaasdasa',
                    title: 'test',
                    start: '2023-07-19T17:30:00+07',
                    end: '2023-07-19T20:30:00+07',
                    level:1,
                    extendedProps: {createdBy: 'Thuan', summary: 'giôi thieu ne', level: 1},
                    duration: '05:00',
                    allDay: false
                })
            }}>Hello</Button>
